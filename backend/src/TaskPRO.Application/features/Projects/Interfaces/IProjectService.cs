...
namespace TaskPRO.Application.features.Projects.Interfaces
{
    public interface IProjectService
    {
        ...
        Task<ProjectDetailResponse> GetProjectByIdAsync(Guid projectId, Guid CurrentUserId, bool isAdmin);
        ...
        Task<ProjectMemberResponse> AddProjectMemberAsync(Guid projectId, Guid userId, string role,Guid currentUserId);
        ...
        Task<ProjectResponse> ArchiveProjectAsync(Guid CurrentUserId, Guid projectId);
        Task<ProjectResponse> DeleteProjectAsync(Guid CurrentUserId, Guid projectId);
